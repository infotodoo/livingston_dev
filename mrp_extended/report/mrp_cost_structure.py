...
class MrpCostStructureSupra(models.AbstractModel):
    _name = 'report.mrp_extended.mrp_cost_structure'
...
class ProductTemplateCostStructureSupra(models.AbstractModel):
    _name = 'report.mrp_extended.product_template_cost_structure'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        res = self.env['report.mrp_extended.mrp_cost_structure'].get_lines(productions)
        return {'lines': res}
