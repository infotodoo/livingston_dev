...
class InvoiceService(Component):
    ...
    _usage = "invoice"
    _collection = "base.rest.quasfar.private.services"
    _description = """
        Invoice Services
    ...
    def create(self, **params):
        ...
        for line in invoice_line_ids:
            values = {'name':line['name'], 
                       'sale_ok': line.pop('sale_ok'),
                        #'dafault_code' : line.pop('dafault_code'),
                        'categ_id' : line.pop('categ_id'),
                        'uom_id':line.pop('uom_id') 
                       }
        ...
        res = {
            ...
            "invoice_line_ids" : {
                ...
                "schema":{
                    ...
                    #'dafault_code' :{"type": "string", "required": True, "empty": False},
                    'categ_id' : {"type": "integer", "required": True, "empty": False},
                    "uom_id": {"type": "integer", "required": True, "empty": False},
